...
PositionValue: TypeAlias = int | float
PositionTuple: TypeAlias = tuple[PositionValue, PositionValue]
PositionOperand: TypeAlias = Union[int, float, PositionTuple, "Position"]
